...
if(!env.AUTO_DETERMINE_YEAR_AND_SEMESTER&&(yearAndSemesterEnv.YEAR==undefined||yearAndSemesterEnv.SEMESTER==undefined)){
  throw new EnvError("YEAR and SEMESTER are required with AUTO_DETERMINE_YEAR_AND_SEMESTER off")
}
