  ...
  export async function assignmentExists(
    ...
    if (
      assignmentsCache.get(
        assignment.mcvCourseID + assignment.assignmentName
      ) !== undefined
    ) {
      return true
    }
...
// export async function channelOfGuildExists(NotificationChannel: NotificationChannel): Promise<boolean>{
...
// export type NotificationChannel = NotificationChannel;
